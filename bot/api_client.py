...
class APIClient:
    ...
    async def rate_material(self, telegram_user_id: int, menu_item_id: int, rating: int) -> bool:
    ...
    async def create_user_question(self, telegram_user_id: int, question: str) -> bool:

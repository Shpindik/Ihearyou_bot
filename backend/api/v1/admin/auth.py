...
async def login_admin(request: AdminLoginRequest) -> AdminLoginResponse:
...
@router.post(
    "/refresh", response_model=AdminRefreshResponse, status_code=status.HTTP_200_OK
)
async def refresh_token(request: AdminRefreshRequest) -> AdminRefreshResponse:

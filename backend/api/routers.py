...
from .v1.public.user_activities import router as public_user_activities_router
from .v1.public.user_questions import router as public_user_questions_router
...
from .v1.admin.users import router as admin_users_router
from .v1.admin.menu import router as admin_menu_router
from .v1.admin.questions import router as admin_questions_router
from .v1.admin.analytics import router as admin_analytics_router
from .v1.admin.notifications import router as admin_notifications_router
from .v1.admin.reminder_templates import router as admin_reminder_templates_router

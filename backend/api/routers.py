...
from .v1.admin.telegram_user import router as admin_users_router
from .v1.bot.reminder_template import router as bot_reminder_template_router
...
from .v1.public.question import router as public_questions_router
...
api_router.include_router(bot_reminder_template_router)
...
api_router.include_router(public_questions_router)

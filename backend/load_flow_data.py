...
class FlowDataLoader:
    ...
    async def _create_subitems(
        self, session, parent_id: int, subitems: List[Dict[str, Any]]
    ):
    ...
    async def load_all_data(self):
        ...
        async with AsyncSessionLocal() as session:
            try:
                ...
                print("\n📊 Статистика:")
                print("• Основных разделов: 4")
                print("• Подразделов: 15")
                print("• Всего пунктов меню: 19")
                print("• Контентных блоков: 19")
